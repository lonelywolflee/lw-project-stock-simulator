...
- **이중 시장 지원**: KOSPI/NASDAQ 비율 조절, USD/KRW 환율 자동 환산
...
| 문서 | 내용 |
|------|------|
| [아키텍처](docs/architecture.md) | 시스템 구조, 기술 스택, 주요 파일 |
| [개발 가이드](docs/development.md) | 환경 설정, 실행, 명령어 |
| [코딩 규칙](docs/conventions.md) | 규칙, 주의사항 |
| [테스트](docs/testing.md) | 테스트 전략, 실행 방법 |
| [매매 알고리즘](docs/algorithm.md) | 알고리즘 상세 명세 |
